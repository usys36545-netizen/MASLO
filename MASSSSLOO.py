...
class App(QWidget):
    ...
    # Метод для настройки комбобокса
    def ComboBox(self):
    ...
    def on_combo_activated(self, index):
        ...
        if index == 0:  # 'Начало' находится на 1-й позиции (индекс 0)
            ...
            self.o.label.setText('<html><head/><body><p><span style=" font-size:28pt; font-weight:600;">Добро пожаловать!</span><span style=" font-size:28pt;"><br/>Это приложение создано для тех, кто<br/>только начинает свой путь на кухне — или хочет<br/>освежить базовые навыки. Здесь вы найдёте понятные<br/>инструкции, полезные советы и пошаговые рецепты. </span></p><p><span style=" font-size:28pt;">Удачи и приятного аппетита!</span></p></body></html>')
